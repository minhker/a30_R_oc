...
dtbblock=/dev/block/platform/13500000.dwmmc0/by-name/dtb;
is_slot_device=0;
...
#rm -rf /system_root/system/priv-app/SamsungDeviceHealthManagerService;
...
#insert_line /system/etc/init/hw/init.rc "import /init.spectrum.rc" after "import /init.container.rc" "import /init.spectrum.rc";
